...
w.g.tg.tl = w.g.tg.add("iconbutton", [0, 0, 24, 24], tli, { style: "toolbutton" });
w.g.tg.tm = w.g.tg.add("iconbutton", [24, 0, 48, 24], tmi, { style: "toolbutton" });
w.g.tg.tr = w.g.tg.add("iconbutton", [48, 0, 72, 24], tri, { style: "toolbutton" });

// middle row
w.g.mg = w.g.add("group", [0, 24, 96, 48]);
w.g.mg.orientation = "row";
w.g.mg.tl = w.g.mg.add("iconbutton", [0, 0, 24, 24], mli, { style: "toolbutton" });
w.g.mg.tm = w.g.mg.add("iconbutton", [24, 0, 48, 24], mmi, { style: "toolbutton" });
w.g.mg.tr = w.g.mg.add("iconbutton", [48, 0, 72, 24], mri, { style: "toolbutton" });

// bottom row
w.g.bg = w.g.add("group", [0, 48, 96, 72]);
w.g.bg.orientation = "row";
w.g.bg.tl = w.g.bg.add("iconbutton", [0, 0, 24, 24], bli, { style: "toolbutton" });
w.g.bg.tm = w.g.bg.add("iconbutton", [24, 0, 48, 24], bmi, { style: "toolbutton" });
w.g.bg.tr = w.g.bg.add("iconbutton", [48, 0, 72, 24], bri, { style: "toolbutton" });

// this is the ignore masks checkbox
w.im = 0;
apCheck = groupAP2.add("checkbox", undefined, undefined, { name: "apCheck" });
