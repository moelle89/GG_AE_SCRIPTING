...
zoneShape.property("Size").setValue([comp.width, comp.height]);
  ...
  zoneShape.property("Size").expression = 'f = effect("mojo shape Controls")("Comp Size").value;\
...
p = effect("mojo shape Controls")("Roundness");\
(p/100) * m'
  zoneLayer.transform.position.expression = 'f = effect("mojo shape Controls")("Comp Size").value\
