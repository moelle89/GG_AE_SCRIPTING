...
// EDIT_TEXT_GROUP
// ===============
var edit_text_group = edit_text_wrapper.add("group", undefined, { name: "edit_text_group" });
...
var btn_title = edit_text_group.add("button", undefined, undefined, { name: "btn_title" });
btn_title.text = "Title";
btn_title.alignment = ["left", "fill"];
btn_title.preferredSize.width = 60;

var btn_subtext = edit_text_group.add("button", undefined, undefined, { name: "btn_subtext" });
btn_subtext.text = "Subtext";
btn_subtext.alignment = ["left", "fill"];
btn_subtext.preferredSize.width = 80;

var btn_source = edit_text_group.add("button", undefined, undefined, { name: "btn_source" });
...
// EDIT_TEXT_GROUP1
// ================
var edit_text_group1 = edit_text_wrapper.add("group", undefined, { name: "edit_text_group1" });
...
var btn_c2a = edit_text_group1.add("button", undefined, undefined, { name: "btn_c2a" });
btn_c2a.text = "C2A";
btn_c2a.alignment = ["left", "fill"];
btn_c2a.preferredSize.width = 60;

var btn_c2alink = edit_text_group1.add("button", undefined, undefined, { name: "btn_c2alink" });
